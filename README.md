...
- Make sure that `python` is installed and available on system path. I _strongly_ recommend using [`pyenv`](https://github.com/pyenv/pyenv). Python 2 is _not_ supported. It's end of life was on January 1st, 2020.
